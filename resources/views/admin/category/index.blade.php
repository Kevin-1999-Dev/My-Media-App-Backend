    ...
    <div class="col-4 shadow-sm">
        <form action="{{ route('admin#categoryCreate') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ old('categoryTitle') }}" name="categoryTitle" class="form-control" placeholder="Enter Title...">
                @error('categoryTitle')
           ...
           <div class="form-group">
            ...
            <textarea name="categoryDescription" id="" cols="30" rows="10" class="form-control" placeholder="Enter Description...">{{ old('categoryDescription') }}</textarea>
