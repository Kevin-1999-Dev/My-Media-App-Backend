    ...
    <div class="col-4 shadow-sm">
        <form action="{{ route('admin#postCreate') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ old('postTitle') }}" name="postTitle" class="form-control" placeholder="Enter Title...">
                @error('postTitle')
           ...
           <div class="form-group">
            ...
            <textarea name="postDescription" id="" cols="30" rows="10" class="form-control" placeholder="Enter Description...">{{ old('postDescription') }}</textarea>
